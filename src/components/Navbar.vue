    ...
    <nav class="mx-auto flex max-w-9xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12">
        ...
        <Popover class="relative">
          ...
          >
            <PopoverPanel class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-gray-800 shadow-lg ring-1 ring-gray-900/5">
              <div class="p-4">
                <div
                ...
                >
                  <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-700 group-hover:bg-gray-600">
                    <component :is="item.icon" class="h-6 w-6 text-gray-400 group-hover:text-indigo-400" aria-hidden="true" />
                  </div>
                  <div class="flex-auto">
        ...
        <Menu as="div" class="relative" v-if="authUser">
          <div>
            <MenuButton class="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
              ...
              <img
                class="h-10 w-9 rounded-full"
                :src="authUser.photoURL || '../../isotipo_fabi.png'"
                alt="Foto de perfil"
              />
            </MenuButton>
          </div>
          ...
          >
            <MenuItems class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
              ...
              <MenuItem v-slot="{ active }">
                <a href="#" @click="handleLogout" :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']">Cerrar Sesión</a>
              </MenuItem>
            </MenuItems>
          </transition>
        </Menu>
        ...
        <div class="-my-6 divide-y divide-gray-500/25">
          ...
          <div class="py-6">
            ...
            <Menu as="div" class="relative" v-if="authUser">
              <router-link to="/perfil">
              <a
              class="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-300 hover:bg-gray-700"
              @click="closeMenu"
            >
              Mi Perfil
            </a>
          ...
          <router-link to="/">
              <a
              class="-mx-3 block rounded-lg py-2 px-3 mt-5 text-base font-semibold leading-7 text-red-300 bg-red-700 hover:bg-red-800"
              @click="handleLogout" 
            >
              Cerrar Sesión
            </a>
...
.fade-slide-enter, .fade-slide-leave-to /* .fade-slide-leave-active en versiones anteriores */ {
  opacity: 0;
